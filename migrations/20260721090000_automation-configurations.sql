...
revoke all privileges on table public.automation_configurations from anon, authenticated;
alter table public.automation_configurations enable row level security;
